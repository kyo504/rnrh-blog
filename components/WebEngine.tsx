import { CustomBlockRenderer, CustomTagRendererRecord, isDomElement, MixedStyleDeclaration, MixedStyleRecord, RenderHTMLConfigProvider, TChildrenRenderer, TNode, TRenderEngineConfig, TRenderEngineProvider, useInternalRenderer } from 'react-native-render-html';
...
const ignoreDomNode: TRenderEngineConfig['ignoreDomNode'] = (node) => {
    return isDomElement(node) && !!node.attribs.class?.match(/hash-link/);
}
